...
Дистрибутив распространяемой в составе Рутокен M2M SDK операционной системы собран с использованием проекта Buildroot. В дистрибутиве содержится программное обеспечение с открытым исходным кодом (загрузчики, ядро, библиотеки, программы), распространяемые под различными лицензиями. Проект Buildroot распространяется по лицензии GNU General Public License, версии 2. Исходный код проекта Buildroot, использованный для создания данного дистрибутива, исходный код программных пакетов в составе дистрибутива и информация о лицензиях этих пакетов размещены по пути /usr/share/legal-info.